...
policies_display_map = {
    ...
    '1.3.6.1.4.1.103.100.1.1.3.6': 'lockheed-mediumHardwareDevice',
    ...
    '1.3.6.1.4.1.49507.1.1.1': 'airCanada',
    '1.3.6.1.4.1.49507.1.1.2': 'airCanada',
    '1.3.6.1.4.1.49507.1.1.3': 'airCanada',
    '1.3.6.1.4.1.49507.1.1.4': 'airCanada',
    '1.3.6.1.4.1.49507.1.1.5': 'airCanada',
    '1.3.6.1.4.1.49507.1.1.6': 'airCanada',
    '1.3.6.1.4.1.49507.1.1.7': 'airCanada',
    '1.3.6.1.4.1.49507.1.1.8': 'airCanada',
    ...
    # IdenTrust_Global_Common_CP_v1.4.5_06222018.pdf
    '2.16.840.1.113839.0.100.2.1': 'IGC Basic Software Signing [superseded]',
    '2.16.840.1.113839.0.100.2.3': 'IGC Basic Software Signing',
    '2.16.840.1.113839.0.100.2.2': 'IGC Basic Software Encryption [superseded]',
    '2.16.840.1.113839.0.100.2.4': 'IGC Basic Software Encryption',
    '2.16.840.1.113839.0.100.2.5': 'IGC Basic Hardware Signing',
    '2.16.840.1.113839.0.100.2.6': 'IGC Basic Hardware Encryption',
    '2.16.840.1.113839.0.100.2.7': 'IGC Basic Hardware Card Auth',
    '2.16.840.1.113839.0.100.2.8': 'IGC Basic Hardware Identity',
    '2.16.840.1.113839.0.100.3.1': 'IGC Medium Software Signing',
    '2.16.840.1.113839.0.100.3.2': 'IGC Medium Software Encryption',
    '2.16.840.1.113839.0.100.3.3': 'IGC Medium Software IGC Group Org Sig ',
    '2.16.840.1.113839.0.100.3.4': 'IGC Medium Software IGC Group Org Enc',
    '2.16.840.1.113839.0.100.3.5': 'IGC Medium Software Group Signing',
    '2.16.840.1.113839.0.100.3.6': 'IGC Medium Software Group Encryption',
    '2.16.840.1.113839.0.100.14.1': 'IGC Medium Software CBP Signing',
    '2.16.840.1.113839.0.100.14.2': 'IGC Medium Software CBP Encryption',
    '2.16.840.1.113839.0.100.12.1': 'IGC Medium Hardware Signing',
    '2.16.840.1.113839.0.100.12.2': 'IGC Medium Hardware Encryption',
    '2.16.840.1.113839.0.100.12.3': 'IGC Medium Hardware Card Auth',
    '2.16.840.1.113839.0.100.12.4': 'IGC Medium Hardware Identity',
    '2.16.840.1.113839.0.100.15.1': 'IGC Medium Hardware CBP Signing',
    '2.16.840.1.113839.0.100.15.2': 'IGC Medium Hardware CBP Encryption',
    '2.16.840.1.113839.0.100.15.3': 'IGC Medium Hardware CBP Card Auth',
    '2.16.840.1.113839.0.100.15.4': 'IGC Medium Hardware CBP Identity',
    '2.16.840.1.113839.0.100.18.0': 'IGC PIV-I Hardware Identity',
    '2.16.840.1.113839.0.100.18.1': 'IGC PIV-I Hardware Signing',
    '2.16.840.1.113839.0.100.18.2': 'IGC PIV-I Hardware Encryption',
    '2.16.840.1.113839.0.100.19.1': 'IGC PIV-I Card Authentication',
    '2.16.840.1.113839.0.100.20.1': 'IGC PIV-I Content Signing',
    '2.16.840.1.113839.0.100.37.1': 'IGC Med Device Software',
    '2.16.840.1.113839.0.100.37.2': 'IGC Med Device Software SSL/TLS',
    '2.16.840.1.113839.0.100.37.3': 'IGC Med Device Software Group Device Signing',
    '2.16.840.1.113839.0.100.37.4': 'IGC Med Device Software Group Device Encryption',
    '2.16.840.1.113839.0.100.38.1': 'IGC Med Device Hardware Device',
    '2.16.840.1.113839.0.100.38.2': 'IGC Med Device Hardware SSL/TLS',

    # Entrust Managed Services NFI PKI Assurance Levels
    '2.16.840.1.114027.200.3.10.7.1': 'emspki-nfssp-medium-policy',
    '2.16.840.1.114027.200.3.10.7.2': 'emspki-nfssp-medium-hardware',
    '2.16.840.1.114027.200.3.10.7.3': 'emspki-nfssp-medium-devices',
    '2.16.840.1.114027.200.3.10.7.4': 'emspki-nfssp-mediumauthentication',
    '2.16.840.1.114027.200.3.10.7.5': 'emspki-nfssp-medium-cardAuth',
    '2.16.840.1.114027.200.3.10.7.6': 'emspki-nfssp-pivi-hardware',
    '2.16.840.1.114027.200.3.10.7.7': 'emspki-nfssp-basic-policy',
    '2.16.840.1.114027.200.3.10.7.8': 'emspki-nfssp-rudimentary-policy',
    '2.16.840.1.114027.200.3.10.7.9': 'emspki-nfssp-pivi-contentsigning',
    '2.16.840.1.114027.200.3.10.7.13': 'emspki-nfssp-pivi-cardAuth',
    '2.16.840.1.114027.200.3.10.7.16': 'emspki-nfssp-medium-devicesHW',
    '2.16.840.1.114027.200.3.10.8.1': 'emspki-safeca-basic',
    '2.16.840.1.114027.200.3.10.8.2': 'emspki-safeca-medium-software',
    '2.16.840.1.114027.200.3.10.8.3': 'emspki-safeca-medium-hardware',

    '1.3.6.1.4.1.38099.1.1.1.1': 'tscp-Medium',
    '1.3.6.1.4.1.38099.1.1.1.2': 'tscp-MediumHardware',
    '1.3.6.1.4.1.38099.1.1.1.3': 'tscp-Medium-CBP',
    '1.3.6.1.4.1.38099.1.1.1.4': 'tscp-MediumHardware-CBP',
    '1.3.6.1.4.1.38099.1.1.1.5': 'tscp-PIVI',
    '1.3.6.1.4.1.38099.1.1.1.6': 'tscp-PIVI-CardAuth',
    '1.3.6.1.4.1.38099.1.1.1.7': 'tscp-PIVI-ContentSigning',
    '1.3.6.1.4.1.38099.1.1.1.8': 'tscp-SHA1-Medium',
    '1.3.6.1.4.1.38099.1.1.1.9': 'tscp-SHA1-MediumHardware',
    '1.3.6.1.4.1.38099.1.1.1.10': 'tscp-SHA1-Medium-CBP',
    '1.3.6.1.4.1.38099.1.1.1.11': 'tscp-SHA1-MediumHardware-CBP',
    '1.3.6.1.4.1.38099.1.1.1.12': 'tscp-MediumDevice',
    '1.3.6.1.4.1.38099.1.1.1.13': 'tscp-MediumDeviceHardware',

    # STRAC Bridge
    '1.3.6.1.4.1.39789.2.1': 'strac-certpolicy',
    '1.3.6.1.4.1.39789.2.1.5': 'strac-policies',
    '1.3.6.1.4.1.39789.2.1.5.1': 'strac-rudimentary',
    '1.3.6.1.4.1.39789.2.1.5.2': 'strac-basic',
    '1.3.6.1.4.1.39789.2.1.5.3': 'strac-medium',
    '1.3.6.1.4.1.39789.2.1.5.4': 'strac-mediumHardware',
    '1.3.6.1.4.1.39789.2.1.5.5': 'strac-medium-CBP',
    '1.3.6.1.4.1.39789.2.1.5.6': 'strac-mediumHW-CBP',
    '1.3.6.1.4.1.39789.2.1.5.7': 'strac-pivi-hardware',
    '1.3.6.1.4.1.39789.2.1.5.8': 'strac-pivi-cardAuth',
    '1.3.6.1.4.1.39789.2.1.5.9': 'strac-pivi-contentSigning',
    '1.3.6.1.4.1.39789.2.1.5.10': 'strac-mediumDevice',
    '1.3.6.1.4.1.39789.2.1.5.11': 'strac-mediumDeviceHW',

    # FTI
    '1.3.6.1.4.1.47951.2.2.5': 'fti-policies',
    '1.3.6.1.4.1.47951.2.2.5.1': 'fti-rudimentary',
    '1.3.6.1.4.1.47951.2.2.5.2': 'fti-basic',
    '1.3.6.1.4.1.47951.2.2.5.3': 'fti-medium',
    '1.3.6.1.4.1.47951.2.2.5.4': 'fti-mediumHardware',
    '1.3.6.1.4.1.47951.2.2.5.5': 'fti-medium-CBP',
    '1.3.6.1.4.1.47951.2.2.5.6': 'fti-mediumHW-CBP',
    '1.3.6.1.4.1.47951.2.2.5.7': 'fti-pivi-hardware',
    '1.3.6.1.4.1.47951.2.2.5.8': 'fti-pivi-cardAuth',
    '1.3.6.1.4.1.47951.2.2.5.9': 'fti-pivi-contentSigning',
    '1.3.6.1.4.1.47951.2.2.5.10': 'fti-mediumDevice',
    '1.3.6.1.4.1.47951.2.2.5.11': 'fti-mediumDeviceHW',

    '1.2.36.1.334.1.2.1.2': 'ADO Individual Medium',
    '1.2.36.1.334.1.2.2.1': 'ADO Resource Low',
    '1.2.36.1.334.1.2.2.2': 'ADO Resource Medium',

    # SAFE Identity Bridge
    '1.3.6.1.4.1.23165.1.4': 'SBCA basic',
    '1.3.6.1.4.1.23165.1.5': 'SBCA mediumSoftware',
    '1.3.6.1.4.1.23165.1.6': 'SBCA mediumHardware',
    '1.3.6.1.4.1.23165.1.7': 'SBCA group-basic',
    '1.3.6.1.4.1.23165.1.8': 'SBCA group-mediumSoftware',
    '1.3.6.1.4.1.23165.1.9': 'SBCA group-mediumHardware',
    '1.3.6.1.4.1.23165.1.10': 'SBCA Custom Commercial',
    '1.3.6.1.4.1.23165.1.27': 'SBCA machine-mediumSoftware',
    '1.3.6.1.4.1.23165.1.28': 'SBCA machine-mediumHardware',

    # SAFE Identity Test Bridge
    '1.3.6.1.4.1.23165.1.34': 'SBCA TEST basic',
    '1.3.6.1.4.1.23165.1.35': 'SBCA TEST mediumSoftware',
    '1.3.6.1.4.1.23165.1.36': 'SBCA TEST mediumHardware',
    '1.3.6.1.4.1.23165.1.37': 'SBCA TEST group-basic',
    '1.3.6.1.4.1.23165.1.38': 'SBCA TEST group-mediumSoftware',
    '1.3.6.1.4.1.23165.1.39': 'SBCA TEST group-mediumHardware',
    '1.3.6.1.4.1.23165.1.40': 'SBCA TEST Custom Commercial',
    '1.3.6.1.4.1.23165.1.57': 'SBCA TEST machine-mediumSoftware',
    '1.3.6.1.4.1.23165.1.58': 'SBCA TEST machine-mediumHardware',

    # SAFE Identity Test Issuer
    '1.3.6.1.4.1.23165.101.34': 'SBCA TEST ISSUER basic',
    '1.3.6.1.4.1.23165.101.35': 'SBCA TEST ISSUER mediumSoftware',
    '1.3.6.1.4.1.23165.101.36': 'SBCA TEST ISSUER mediumHardware',
    '1.3.6.1.4.1.23165.101.37': 'SBCA TEST ISSUER group-basic',
    '1.3.6.1.4.1.23165.101.38': 'SBCA TEST ISSUER group-mediumSoftware',
    '1.3.6.1.4.1.23165.101.39': 'SBCA TEST ISSUER group-mediumHardware',
    '1.3.6.1.4.1.23165.101.40': 'SBCA TEST ISSUER Custom Commercial',
    '1.3.6.1.4.1.23165.101.57': 'SBCA TEST ISSUER machine-mediumSoftware',
    '1.3.6.1.4.1.23165.101.58': 'SBCA TEST ISSUER machine-mediumHardware',

    '1.3.6.1.4.1.39965.1.1.1': 'Trans Sped QCA G2 OID',
    '1.3.6.1.4.1.39965.2.1.1': 'Trans Sped Medium Hardware',
    '1.3.6.1.4.1.39965.2.1.3': 'Trans Sped Medium Hardware Roaming',
    '1.3.6.1.4.1.39965.3.1.1': 'MOBILE QCA (CT-CSSP-CA-A1 / Cybertrust)',
    '1.3.6.1.4.1.39965.3.1.3': 'MOBILE QCA (CT-CSSP-CA-A1 / Cybertrust)',
    '1.3.6.1.4.1.39965.4.1.1': 'MOBILE eIDAS QCA',
    # http://www.etsi.org/deliver/etsi_en/319400_319499/31941102/02.01.01_60/en_31941102v020101p.pdf
    '0.4.0.194112.1.0': 'ETSI QCP Natural',
    '0.4.0.194112.1.1': 'ETSI QCP Legal',
    '0.4.0.194112.1.2': 'ETSI QCP Natural QSCD',
    '0.4.0.194112.1.3': 'ETSI QCP Legal QSCD',
    '0.4.0.194112.1.4': 'ETSI QCP Web',
    #  ETSI TS 101 456
    '0.4.0.1456.1.1': 'ETSI QCP Public with SSCD',
    '0.4.0.1456.1.2': 'ETSI QCP Public',
    # Exostar
    '1.3.6.1.4.1.13948.1.1.1.1': 'Exostar mediumSoftware',
    '1.3.6.1.4.1.13948.1.1.1.2': 'Exostar mediumHardware',
    '1.3.6.1.4.1.13948.1.1.1.3': 'Exostar mediumSoftware biopharma',
    '1.3.6.1.4.1.13948.1.1.1.4': 'Exostar mediumHardware biopharma',
    '1.3.6.1.4.1.13948.1.1.1.5': 'Exostar mediumSoftware sha2',
    '1.3.6.1.4.1.13948.1.1.1.6': 'Exostar mediumHardware sha2',
    '1.3.6.1.4.1.13948.1.1.1.7': 'Exostar basic',
    '1.3.6.1.4.1.13948.1.1.1.8': 'Exostar basic sha2',
    '1.3.6.1.4.1.13948.1.1.1.20': 'Exostar exostarGeneralUse',
    '1.3.6.1.4.1.13948.1.1.1.23': 'Exostar mediumSoftware biopharma sha2',
    '1.3.6.1.4.1.13948.1.1.1.24': 'Exostar mediumHardware biopharma sha2',
    '1.3.6.1.4.1.13948.1.1.1.25': 'Exostar mediumSoftware device sha2',
    '1.3.6.1.4.1.13948.1.1.1.26': 'Exostar mediumHardware device sha2',
    '1.3.6.1.4.1.13948.1.1.1.29': 'Exostar basic biopharma sha2',
    '1.3.6.1.4.1.13948.2.2.2.1.20': 'Exostar General Use Operations',
